...
} Pystd__map__lt___std__string__double___gt__;


typedef struct {
    PyObject_HEAD
    Pystd__map__lt___std__string__double___gt__ *container;
    std::map< std::string, double >::iterator *iterator;
} Pystd__map__lt___std__string__double___gt__Iter;


extern PyTypeObject Pystd__map__lt___std__string__double___gt___Type;
extern PyTypeObject Pystd__map__lt___std__string__double___gt__Iter_Type;
