...
PyObject *
_wrap_PyNs3PacketSink_GetFlowEndTMap(PyNs3PacketSink *self)
{
    PyObject *py_retval;
    std::map< std::string, double > retval;
    Pystd__map__lt___std__string__double___gt__ *py_std__map__lt___std__string__double___gt__;
    
    retval = self->obj->GetFlowEndTMap();
    py_std__map__lt___std__string__double___gt__ = PyObject_New(Pystd__map__lt___std__string__double___gt__, &Pystd__map__lt___std__string__double___gt___Type);
    py_std__map__lt___std__string__double___gt__->obj = new std::map< std::string, double >(retval);
    py_retval = Py_BuildValue((char *) "N", py_std__map__lt___std__string__double___gt__);
    return py_retval;
}
...
PyObject *
_wrap_PyNs3PacketSink_GetFlowReodelayMap(PyNs3PacketSink *self)
{
    PyObject *py_retval;
    std::map< std::string, double > retval;
    Pystd__map__lt___std__string__double___gt__ *py_std__map__lt___std__string__double___gt__;
    
    retval = self->obj->GetFlowReodelayMap();
    py_std__map__lt___std__string__double___gt__ = PyObject_New(Pystd__map__lt___std__string__double___gt__, &Pystd__map__lt___std__string__double___gt___Type);
    py_std__map__lt___std__string__double___gt__->obj = new std::map< std::string, double >(retval);
    py_retval = Py_BuildValue((char *) "N", py_std__map__lt___std__string__double___gt__);
    return py_retval;
...
PyObject *
_wrap_PyNs3PacketSink_GetFlowNByteMap(PyNs3PacketSink *self)
{
    PyObject *py_retval;
    ...
    retval = self->obj->GetFlowNByteMap();
    ...
    py_std__map__lt___std__string__unsigned_long___gt__->obj = new std::map< std::string, unsigned long >(retval);
...
PyObject *
_wrap_PyNs3PacketSink_GetFlowNSegmentMap(PyNs3PacketSink *self)
{
    PyObject *py_retval;
    ...
    retval = self->obj->GetFlowNSegmentMap();
    ...
    py_std__map__lt___std__string__unsigned_int___gt__->obj = new std::map< std::string, unsigned int >(retval);
...
static PyMethodDef PyNs3PacketSink_methods[] = {
    {(char *) "GetFlowEndTMap", (PyCFunction) _wrap_PyNs3PacketSink_GetFlowEndTMap, METH_NOARGS, NULL },
    {(char *) "GetTypeId", (PyCFunction) _wrap_PyNs3PacketSink_GetTypeId, METH_NOARGS|METH_STATIC, NULL },
    {(char *) "GetFlowReodelayMap", (PyCFunction) _wrap_PyNs3PacketSink_GetFlowReodelayMap, METH_NOARGS, NULL },
    {(char *) "GetFlowNByteMap", (PyCFunction) _wrap_PyNs3PacketSink_GetFlowNByteMap, METH_NOARGS, NULL },
    ...
    {(char *) "GetFlowNSegmentMap", (PyCFunction) _wrap_PyNs3PacketSink_GetFlowNSegmentMap, METH_NOARGS, NULL },
...
PyTypeObject Pystd__map__lt___std__string__unsigned_long___gt___Type = {
    PyObject_HEAD_INIT(NULL)
    0,                                 /* ob_size */
    (char *) "applications.Std__map__lt___std__string__unsigned_long___gt__",            /* tp_name */
...
PyTypeObject Pystd__map__lt___std__string__unsigned_long___gt__Iter_Type = {
    PyObject_HEAD_INIT(NULL)
    0,                                 /* ob_size */
    (char *) "applications.Std__map__lt___std__string__unsigned_long___gt__Iter",            /* tp_name */
...
static void
Pystd__map__lt___std__string__double___gt__Iter__tp_clear(Pystd__map__lt___std__string__double___gt__Iter *self)
{
    Py_CLEAR(self->container);
    delete self->iterator;
    self->iterator = NULL;
...
static int
Pystd__map__lt___std__string__double___gt__Iter__tp_traverse(Pystd__map__lt___std__string__double___gt__Iter *self, visitproc visit, void *arg)
{
    Py_VISIT((PyObject *) self->container);
    return 0;
}
...
static void
_wrap_Pystd__map__lt___std__string__double___gt____tp_dealloc(Pystd__map__lt___std__string__double___gt__ *self)
{
    delete self->obj;
    self->obj = NULL;
...
static void
_wrap_Pystd__map__lt___std__string__double___gt__Iter__tp_dealloc(Pystd__map__lt___std__string__double___gt__Iter *self)
{
    Py_CLEAR(self->container);
    delete self->iterator;
    self->iterator = NULL;
...
static PyObject*
_wrap_Pystd__map__lt___std__string__double___gt____tp_iter(Pystd__map__lt___std__string__double___gt__ *self)
{
    Pystd__map__lt___std__string__double___gt__Iter *iter = PyObject_GC_New(Pystd__map__lt___std__string__double___gt__Iter, &Pystd__map__lt___std__string__double___gt__Iter_Type);
    Py_INCREF(self);
    iter->container = self;
    iter->iterator = new std::map< std::string, double >::iterator(self->obj->begin());
    return (PyObject*) iter;
}


static PyObject*
_wrap_Pystd__map__lt___std__string__double___gt__Iter__tp_iter(Pystd__map__lt___std__string__double___gt__Iter *self)
{
    Py_INCREF(self);
    return (PyObject*) self;
}

static PyObject* _wrap_Pystd__map__lt___std__string__double___gt__Iter__tp_iternext(Pystd__map__lt___std__string__double___gt__Iter *self)
{
    PyObject *py_retval;
    ...
    ++(*self->iterator);
    py_retval = Py_BuildValue((char *) "s#d", (iter->first).c_str(), (iter->first).size(), iter->second);
    return py_retval;
}
...
int _wrap_convert_py2c__std__map__lt___std__string__double___gt__(PyObject *arg, std::map< std::string, double > *container)
{
    if (PyObject_IsInstance(arg, (PyObject*) &Pystd__map__lt___std__string__double___gt___Type)) {
        *container = *((Pystd__map__lt___std__string__double___gt__*)arg)->obj;
    } else if (PyList_Check(arg)) {
        container->clear();
        Py_ssize_t size = PyList_Size(arg);
        for (Py_ssize_t i = 0; i < size; i++) {
            ...
            if (!_wrap_convert_py2c__double(PyTuple_GET_ITEM(tup, 1), &item.second)) {
                return 0;
            }
            container->insert(item);
        }
    } else {
        PyErr_SetString(PyExc_TypeError, "parameter must be None, a Std__map__lt___std__string__double___gt__ instance, or a list of double");
        return 0;
    }
    return 1;
}
...
static int
_wrap_Pystd__map__lt___std__string__double___gt____tp_init(Pystd__map__lt___std__string__double___gt__ *self, PyObject *args, PyObject *kwargs)
{
    const char *keywords[] = {"arg", NULL};
    PyObject *arg = NULL;
    ...
    self->obj = new std::map< std::string, double >;

    if (arg == NULL)
        return 0;

    if (!_wrap_convert_py2c__std__map__lt___std__string__double___gt__(arg, self->obj)) {
        delete self->obj;
        self->obj = NULL;
        return -1;
    }
...
PyTypeObject Pystd__map__lt___std__string__double___gt___Type = {
    PyObject_HEAD_INIT(NULL)
    0,                                 /* ob_size */
    (char *) "applications.Std__map__lt___std__string__double___gt__",            /* tp_name */
    sizeof(Pystd__map__lt___std__string__double___gt__),                  /* tp_basicsize */
    0,                                 /* tp_itemsize */
    /* methods */
    (destructor)_wrap_Pystd__map__lt___std__string__double___gt____tp_dealloc,        /* tp_dealloc */
    (printfunc)0,                      /* tp_print */
    (getattrfunc)NULL,       /* tp_getattr */
    (setattrfunc)NULL,       /* tp_setattr */
    (cmpfunc)NULL,           /* tp_compare */
    ...
    (richcmpfunc)NULL,   /* tp_richcompare */
    0,             /* tp_weaklistoffset */
    (getiterfunc)_wrap_Pystd__map__lt___std__string__double___gt____tp_iter,          /* tp_iter */
    (iternextfunc)NULL,     /* tp_iternext */
    (struct PyMethodDef*)NULL, /* tp_methods */
    (struct PyMemberDef*)0,              /* tp_members */
    NULL,                     /* tp_getset */
    ...
    (descrsetfunc)NULL,    /* tp_descr_set */
    0,                 /* tp_dictoffset */
    (initproc)_wrap_Pystd__map__lt___std__string__double___gt____tp_init,             /* tp_init */
    (allocfunc)PyType_GenericAlloc,           /* tp_alloc */
    (newfunc)PyType_GenericNew,               /* tp_new */
    (freefunc)0,             /* tp_free */
    (inquiry)NULL,             /* tp_is_gc */
...
PyTypeObject Pystd__map__lt___std__string__double___gt__Iter_Type = {
    PyObject_HEAD_INIT(NULL)
    0,                                 /* ob_size */
    (char *) "applications.Std__map__lt___std__string__double___gt__Iter",            /* tp_name */
    sizeof(Pystd__map__lt___std__string__double___gt__Iter),                  /* tp_basicsize */
    0,                                 /* tp_itemsize */
    /* methods */
    (destructor)_wrap_Pystd__map__lt___std__string__double___gt__Iter__tp_dealloc,        /* tp_dealloc */
    (printfunc)0,                      /* tp_print */
    (getattrfunc)NULL,       /* tp_getattr */
    (setattrfunc)NULL,       /* tp_setattr */
    (cmpfunc)NULL,           /* tp_compare */
    ...
    Py_TPFLAGS_DEFAULT|Py_TPFLAGS_HAVE_GC,                      /* tp_flags */
    NULL,                        /* Documentation string */
    (traverseproc)Pystd__map__lt___std__string__double___gt__Iter__tp_traverse,     /* tp_traverse */
    (inquiry)Pystd__map__lt___std__string__double___gt__Iter__tp_clear,             /* tp_clear */
    (richcmpfunc)NULL,   /* tp_richcompare */
    0,             /* tp_weaklistoffset */
    (getiterfunc)_wrap_Pystd__map__lt___std__string__double___gt__Iter__tp_iter,          /* tp_iter */
    (iternextfunc)_wrap_Pystd__map__lt___std__string__double___gt__Iter__tp_iternext,     /* tp_iternext */
    (struct PyMethodDef*)NULL, /* tp_methods */
    (struct PyMemberDef*)0,              /* tp_members */
    NULL,                     /* tp_getset */
    NULL,                              /* tp_base */
...
PyTypeObject Pystd__map__lt___std__string__unsigned_int___gt___Type = {
    PyObject_HEAD_INIT(NULL)
    0,                                 /* ob_size */
    (char *) "applications.Std__map__lt___std__string__unsigned_int___gt__",            /* tp_name */
...
PyTypeObject Pystd__map__lt___std__string__unsigned_int___gt__Iter_Type = {
    PyObject_HEAD_INIT(NULL)
    0,                                 /* ob_size */
    (char *) "applications.Std__map__lt___std__string__unsigned_int___gt__Iter",            /* tp_name */
...
initapplications(void)
{
    ...
    /* Register the 'std::map< std::string, double >' class */
    if (PyType_Ready(&Pystd__map__lt___std__string__double___gt___Type)) {
        return;
    }
    if (PyType_Ready(&Pystd__map__lt___std__string__double___gt__Iter_Type)) {
        return;
    }
    PyModule_AddObject(m, (char *) "Std__map__lt___std__string__double___gt__", (PyObject *) &Pystd__map__lt___std__string__double___gt___Type);
    PyModule_AddObject(m, (char *) "Std__map__lt___std__string__double___gt__Iter", (PyObject *) &Pystd__map__lt___std__string__double___gt__Iter_Type);
