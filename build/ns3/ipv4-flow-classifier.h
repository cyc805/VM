...
public:
	...
	/*---------------------------------Chunzhi-------------------------------------*/
	// Searches for the FlowId corresponding to the given five tuple.
	FlowId FindFlowId(std::string tuple) const;
	/*-----------------------------------------------------------------------------*/

public: // by Chunzhi: change from private to public

	std::map<FiveTuple, FlowId> m_flowMap;

	/*---------------------------------- by Chunzhi--------------------------*/
	std::map<FlowId, FiveTuple> idTupleMap;
	std::map<std::string, FlowId> tupleIdMap;
	/*-----------------------------------------------------------------------*/
