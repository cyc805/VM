...
def register_types(module):
    ...
    module.add_container('std::map< std::string, double >', ('std::string', 'double'), container_type='map')
...
def register_Ns3PacketSink_methods(root_module, cls):
    ...
    cls.add_method('GetAcceptedSockets', 
                   ...
                   [], 
                   is_const=True)
    ## packet-sink.h (module 'applications'): std::map<std::string, double, std::less<std::string>, std::allocator<std::pair<std::string const, double> > > ns3::PacketSink::GetFlowEndTMap() [member function]
    cls.add_method('GetFlowEndTMap', 
                   'std::map< std::string, double >', 
                   [])
    ## packet-sink.h (module 'applications'): std::map<std::string, unsigned long, std::less<std::string>, std::allocator<std::pair<std::string const, unsigned long> > > ns3::PacketSink::GetFlowNByteMap() [member function]
    cls.add_method('GetFlowNByteMap', 
                   'std::map< std::string, unsigned long >', 
                   [])
    ## packet-sink.h (module 'applications'): std::map<std::string, unsigned int, std::less<std::string>, std::allocator<std::pair<std::string const, unsigned int> > > ns3::PacketSink::GetFlowNSegmentMap() [member function]
    cls.add_method('GetFlowNSegmentMap', 
                   'std::map< std::string, unsigned int >', 
                   [])
    ## packet-sink.h (module 'applications'): std::map<std::string, double, std::less<std::string>, std::allocator<std::pair<std::string const, double> > > ns3::PacketSink::GetFlowReodelayMap() [member function]
    cls.add_method('GetFlowReodelayMap', 
                   'std::map< std::string, double >', 
                   [])
