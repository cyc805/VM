...
def register_types(module):
    ...
    module.add_class('Ipv4EndPoint', import_from_module='ns.internet')
    ...
    ## simple-ref-count.h (module 'core'): ns3::SimpleRefCount<ns3::FlowProbe, ns3::empty, ns3::DefaultDeleter<ns3::FlowProbe> > [class]
    ...
    ## myutil.h (module 'internet'): ns3::MyOutputStreamWrapper [class]
    module.add_class('MyOutputStreamWrapper', import_from_module='ns.internet', parent=root_module['ns3::Object'])
    ...
    module.add_container('std::map< unsigned int, ns3::Time >', ('unsigned int', 'ns3::Time'), container_type='map')
    ...
    module.add_container('std::map< std::pair< unsigned int, unsigned int >, ns3::FlowMonitor::TrackedPacket >', ('std::pair< unsigned int, unsigned int >', 'ns3::FlowMonitor::TrackedPacket'), container_type='map')
    ...
    module.add_container('std::map< ns3::Ipv4FlowClassifier::FiveTuple, unsigned int >', ('ns3::Ipv4FlowClassifier::FiveTuple', 'unsigned int'), container_type='map')
    module.add_container('std::map< unsigned int, ns3::Ipv4FlowClassifier::FiveTuple >', ('unsigned int', 'ns3::Ipv4FlowClassifier::FiveTuple'), container_type='map')
...
def register_methods(root_module):
    ...
    register_Ns3MyOutputStreamWrapper_methods(root_module, root_module['ns3::MyOutputStreamWrapper'])
...
def register_Ns3SimpleRefCount__Ns3FlowProbe_Ns3Empty_Ns3DefaultDeleter__lt__ns3FlowProbe__gt___methods(root_module, cls):
    ## simple-ref-count.h (module 'core'): ns3::SimpleRefCount<ns3::FlowProbe, ns3::empty, ns3::DefaultDeleter<ns3::FlowProbe> >::SimpleRefCount() [constructor]
    cls.add_constructor([])
    ## simple-ref-count.h (module 'core'): ns3::SimpleRefCount<ns3::FlowProbe, ns3::empty, ns3::DefaultDeleter<ns3::FlowProbe> >::SimpleRefCount(ns3::SimpleRefCount<ns3::FlowProbe, ns3::empty, ns3::DefaultDeleter<ns3::FlowProbe> > const & o) [copy constructor]
    cls.add_constructor([param('ns3::SimpleRefCount< ns3::FlowProbe, ns3::empty, ns3::DefaultDeleter< ns3::FlowProbe > > const &', 'o')])
    ## simple-ref-count.h (module 'core'): static void ns3::SimpleRefCount<ns3::FlowProbe, ns3::empty, ns3::DefaultDeleter<ns3::FlowProbe> >::Cleanup() [member function]
    cls.add_method('Cleanup', 
                   'void', 
                   [], 
                   is_static=True)
...
def register_Ns3FlowMonitor_methods(root_module, cls):
    ...
    cls.add_method('GetAllProbes', 
                   ...
                   [], 
                   is_const=True)
    ## flow-monitor.h (module 'flow-monitor'): ns3::Ptr<ns3::FlowClassifier> ns3::FlowMonitor::GetFlowClassifier() [member function]
    cls.add_method('GetFlowClassifier', 
                   'ns3::Ptr< ns3::FlowClassifier >', 
                   [])
    ...
    cls.add_method('GetTypeId', 
                   ...
                   [], 
                   is_static=True)
    ## flow-monitor.h (module 'flow-monitor'): void ns3::FlowMonitor::RecordFlowStat(ns3::FlowId flowId) [member function]
    cls.add_method('RecordFlowStat', 
                   'void', 
                   [param('ns3::FlowId', 'flowId')])
    ## flow-monitor.h (module 'flow-monitor'): void ns3::FlowMonitor::RecordFlowStats() [member function]
    cls.add_method('RecordFlowStats', 
                   'void', 
                   [])
    ## flow-monitor.h (module 'flow-monitor'): void ns3::FlowMonitor::RecordPkt(uint32_t nodeId, ns3::Ptr<ns3::Ipv4FlowClassifier> classifier, ns3::FlowId flowId, ns3::Ipv4Header const & ipHeader, ns3::Ptr<ns3::Packet> pkt, std::string event) [member function]
    cls.add_method('RecordPkt', 
                   'void', 
                   [param('uint32_t', 'nodeId'), param('ns3::Ptr< ns3::Ipv4FlowClassifier >', 'classifier'), param('ns3::FlowId', 'flowId'), param('ns3::Ipv4Header const &', 'ipHeader'), param('ns3::Ptr< ns3::Packet >', 'pkt'), param('std::string', 'event')])
    ...
    ## flow-monitor.h (module 'flow-monitor'): void ns3::FlowMonitor::ReportDropPkt(uint32_t nodeId, ns3::Ptr<ns3::Ipv4FlowClassifier> classifier, ns3::FlowId flowId, ns3::Ptr<ns3::Packet> pkt) [member function]
    cls.add_method('ReportDropPkt', 
                   'void', 
                   [param('uint32_t', 'nodeId'), param('ns3::Ptr< ns3::Ipv4FlowClassifier >', 'classifier'), param('ns3::FlowId', 'flowId'), param('ns3::Ptr< ns3::Packet >', 'pkt')])
    ...
    cls.add_method('StopRightNow', 
                   'void', 
                   [])
    ## flow-monitor.h (module 'flow-monitor'): ns3::FlowMonitor::m_flowStats [variable]
    cls.add_instance_attribute('m_flowStats', 'std::map< unsigned int, ns3::FlowMonitor::FlowStats >', is_const=False)
    ## flow-monitor.h (module 'flow-monitor'): ns3::FlowMonitor::m_trackedPackets [variable]
    cls.add_instance_attribute('m_trackedPackets', 'std::map< std::pair< unsigned int, unsigned int >, ns3::FlowMonitor::TrackedPacket >', is_const=False)
...
def register_Ns3FlowMonitorFlowStats_methods(root_module, cls):
    ...
    ## flow-monitor.h (module 'flow-monitor'): ns3::FlowMonitor::FlowStats::hop_delaySum [variable]
    cls.add_instance_attribute('hop_delaySum', 'std::map< unsigned int, ns3::Time >', is_const=False)
    ## flow-monitor.h (module 'flow-monitor'): ns3::FlowMonitor::FlowStats::hop_nPackets [variable]
    cls.add_instance_attribute('hop_nPackets', 'std::map< unsigned int, unsigned int >', is_const=False)
    ...
    ## flow-monitor.h (module 'flow-monitor'): ns3::FlowMonitor::FlowStats::route_nPkts [variable]
    cls.add_instance_attribute('route_nPkts', 'std::map< std::string, unsigned int >', is_const=False)
...
def register_Ns3Ipv4FlowClassifier_methods(root_module, cls):
    ...
    cls.add_method('FindFlow', 
                   ...
                   [param('ns3::FlowId', 'flowId')], 
                   is_const=True)
    ## ipv4-flow-classifier.h (module 'flow-monitor'): ns3::FlowId ns3::Ipv4FlowClassifier::FindFlowId(std::string tuple) const [member function]
    cls.add_method('FindFlowId', 
                   'ns3::FlowId', 
                   [param('std::string', 'tuple')], 
                   is_const=True)
    ...
    cls.add_method('SerializeToXmlStream', 
                   ...
                   [param('std::ostream &', 'os'), param('int', 'indent')], 
                   is_const=True, is_virtual=True)
    ## ipv4-flow-classifier.h (module 'flow-monitor'): ns3::Ipv4FlowClassifier::idTupleMap [variable]
    cls.add_instance_attribute('idTupleMap', 'std::map< unsigned int, ns3::Ipv4FlowClassifier::FiveTuple >', is_const=False)
    ## ipv4-flow-classifier.h (module 'flow-monitor'): ns3::Ipv4FlowClassifier::m_flowMap [variable]
    cls.add_instance_attribute('m_flowMap', 'std::map< ns3::Ipv4FlowClassifier::FiveTuple, unsigned int >', is_const=False)
    ## ipv4-flow-classifier.h (module 'flow-monitor'): ns3::Ipv4FlowClassifier::tupleIdMap [variable]
    cls.add_instance_attribute('tupleIdMap', 'std::map< std::string, unsigned int >', is_const=False)
    return
...
def register_Ns3Ipv4FlowProbe_methods(root_module, cls):
    ...
    ## ipv4-flow-probe.h (module 'flow-monitor'): uint32_t ns3::Ipv4FlowProbe::GetNodeId() [member function]
    cls.add_method('GetNodeId', 
                   'uint32_t', 
                   [])
    return
...
def register_Ns3MyOutputStreamWrapper_methods(root_module, cls):
    ## myutil.h (module 'internet'): ns3::MyOutputStreamWrapper::MyOutputStreamWrapper(ns3::MyOutputStreamWrapper const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::MyOutputStreamWrapper const &', 'arg0')])
    ## myutil.h (module 'internet'): ns3::MyOutputStreamWrapper::MyOutputStreamWrapper() [constructor]
    cls.add_constructor([])
    ## myutil.h (module 'internet'): ns3::MyOutputStreamWrapper::MyOutputStreamWrapper(ns3::Ptr<ns3::OutputStreamWrapper> osw) [constructor]
    cls.add_constructor([param('ns3::Ptr< ns3::OutputStreamWrapper >', 'osw')])
    ## myutil.h (module 'internet'): static ns3::TypeId ns3::MyOutputStreamWrapper::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## myutil.h (module 'internet'): ns3::MyOutputStreamWrapper::m_osw [variable]
    cls.add_instance_attribute('m_osw', 'ns3::Ptr< ns3::OutputStreamWrapper >', is_const=False)
    return
